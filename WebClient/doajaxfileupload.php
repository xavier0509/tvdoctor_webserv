            ...
            if($ok === FALSE)
             {
              ...
              $arr = array ('file_result'=>'error','file_path'=>'WebClient/upload/'.$newpath,'file_size'=>$size,'file_error'=>$error); 
              echo json_encode($arr); 
             }
             else
             {
                  $arr = array ('file_result'=>'ok','file_path'=>'WebClient/upload/'.$newpath,'file_size'=>$size,'file_error'=>$error); 
              echo json_encode($arr);   
            }
        }
    }
